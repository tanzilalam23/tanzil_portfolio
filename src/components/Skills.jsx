...
const Skills = () => {
  return (
    <section id="skills" className="py-16 text-center bg-[rgb(17,24,39)] dark:bg-[rgb(17,24,39)]">
      <div className="container mx-auto px-6 md:px-16">
        ...
        <div className="rounded-2xl bg-[rgba(37,40,131,0.8)] border border-white shadow-xl transition-all duration-300 hover:scale-[1.02] p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-lg md:w-2/3">
              {skills.map((skill, index) => (
                <span
                  key={index}
                  className="skill-tag flex items-center gap-2 px-3 py-1 rounded-full font-medium text-white"
