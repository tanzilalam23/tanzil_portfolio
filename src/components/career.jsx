...
const FloatingParticles = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
    {PARTICLES.map((p) => (
      <div key={p.id} className="absolute bg-green-400 rounded-full animate-pulse" style={p.style} />
    ))}
  </div>
);
...
const CareerJourney = () => {
  const { t } = useLanguage();
  const careerJourney = t.career.items;
        ...
        {modalContent && (
          <div className="fixed inset-0 flex items-center justify-center bg-black/80 z-50 p-4">
            <div className="bg-gray-900 border border-gray-700 text-gray-200 p-6 rounded-2xl 
              ...
              <h4 className="text-xl font-bold text-green-400 mb-4 pr-12">Reference Letter</h4>
